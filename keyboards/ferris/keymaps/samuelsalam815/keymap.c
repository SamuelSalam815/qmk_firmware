...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[3] = LAYOUT_split_3x5_2(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_8, KC_4, KC_2, KC_1, KC_0, KC_NO, KC_NO, KC_RCTL, KC_RALT, KC_RGUI, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_DOT, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
...
const uint16_t PROGMEM fkey_combo_keys_count          = sizeof(fkey_combo_keys) / sizeof(uint16_t);
const uint16_t PROGMEM number_combo_output_keys[]     = {KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9};
const uint16_t PROGMEM fkey_combo_output_keys[]       = {KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12};
const uint16_t PROGMEM number_combo_output_keys_count = sizeof(number_combo_output_keys) / sizeof(uint16_t);
const uint16_t PROGMEM fkey_combo_output_keys_count   = sizeof(fkey_combo_output_keys) / sizeof(uint16_t);
int8_t number_combo_pressed_count = 0;
int8_t fkey_combo_pressed_count   = 0;
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    if(!process_bitwise_combo(
        keycode,
        record,
        &number_combo_pressed_count,
        &number_combo_output_index,
        number_combo_keys,
        number_combo_keys_count,
        number_combo_output_keys,
        number_combo_output_keys_count)) return false;
    // if(!process_bitwise_combo(
    //     keycode,
    //     record,
    //     &fkey_combo_pressed_count,
    //     &fkey_combo_output_index,
    //     fkey_combo_keys,
