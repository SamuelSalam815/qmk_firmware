...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT_split_3x5_2(KC_NO, KC_LT, KC_GT, KC_TRNS, KC_NO, KC_EXLM, KC_DQUO, KC_QUOT, KC_AT, KC_GRV, KC_LGUI, KC_LALT, KC_LCTL, KC_NO, KC_NO, KC_PLUS, KC_EQL, KC_MINS, KC_ASTR, KC_HASH, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BSLS, KC_PIPE, KC_AMPR, KC_TILD, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
