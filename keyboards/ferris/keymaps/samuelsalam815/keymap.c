...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[4] = LAYOUT_split_3x5_2(LGUI(KC_TAB), KC_NO, CTL_TAB, ALT_TAB, KC_NO, KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_NO, KC_LGUI, KC_LALT, KC_LCTL, KC_TAB, TO(6), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_INS, KC_PSCR, KC_SCRL, KC_PAUS, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
