...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[3] = LAYOUT_split_3x5_2(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_8, KC_4, KC_2, KC_1, KC_SPC, KC_NO, KC_NO, KC_RCTL, KC_RALT, KC_RGUI, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_DOT, KC_NO, KC_TRNS, KC_0, KC_TRNS, KC_TRNS),
	[4] = LAYOUT_split_3x5_2(LGUI(KC_TAB), KC_NO, CTL_TAB, ALT_TAB, TO(6), KC_HOME, KC_PGUP, KC_PGDN, KC_END, KC_NO, KC_LGUI, KC_LALT, KC_LCTL, KC_TAB, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_INS, KC_PSCR, KC_SCRL, KC_PAUS, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
